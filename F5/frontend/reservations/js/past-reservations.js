...
async function fetchReservations() {
    try {
        const reservationsListContainer = document.getElementById('pastReservationsListContainer');
...
function initPastReservations() {    
    ...
    const searchInput = document.getElementById('searchPastReservationInput');
    if (searchInput) {
...
window.initPastReservations = initPastReservations;